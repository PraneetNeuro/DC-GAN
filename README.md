...
# Instantiating the GAN object will train the model and save it in the current working directory, it will also save images generated by the generator periodically
```
